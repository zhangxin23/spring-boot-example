...
public class PersonController {
    ...
    @ResponseBody
    @ApiOperation(value = "Fetch API", notes = "Fetch person by id", response = Person.class)
    ...
    @RequestMapping(value = "persons/object", method = RequestMethod.POST)
    @ResponseBody
    @ApiOperation(value = "Set API", notes = "Add new person by person object into database", response = String.class)
    @ApiResponses(value = {@ApiResponse(code = 500, message = "server error", response = ErrorDetail.class)})
    ...
    @ApiOperation(value = "Update API", notes = "Update person by id and multiply params", response = String.class)
    @ApiResponses(value = {@ApiResponse(code = 500, message = "server error", response = ErrorDetail.class)})
    ...
    @RequestMapping(value = "persons/object/{id}", method = RequestMethod.PUT)
    @ApiOperation(value = "Update API", notes = "Update person by id and person object params into database", response = String.class)
    @ApiResponses(value = {@ApiResponse(code = 500, message = "server error", response = ErrorDetail.class)})
